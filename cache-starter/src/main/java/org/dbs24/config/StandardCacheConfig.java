...
@Log4j2
//@EnableCaching
@ConditionalOnProperty(name="config.cache.redis.enabled", havingValue="true", matchIfMissing=true)
public class StandardCacheConfig extends AbstractCacheConfig {
