...
@Component
public class ProxyUsageErrorValidator extends AbstractValidatorService<ProxyUsageErrorDto> implements EntityInfoValidator<ProxyUsageErrorDto> {

    @Override
    public Collection<ErrorInfo> validate(ProxyUsageErrorDto proxyUsageErrorDto) {
