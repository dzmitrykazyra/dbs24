...
import org.dbs24.card.pmt.rest.payment.api.PaymentInfo;
...
@Component
public class PaymentInfoValidator extends AbstractValidatorService<PaymentInfo> implements EntityInfoValidator<PaymentInfo> {

    final RefsService refsService;

    public PaymentInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(PaymentInfo paymentInfo) {
