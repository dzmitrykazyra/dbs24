...
public class DocumentsConst {
    ...
    public static final String DOCS_TEMPLATES_CLASSES_PACKAGE = "org.dbs24.documents.templates";
    public static final String DOCS_REF_PACKAGE = "org.dbs24.references.documents";
