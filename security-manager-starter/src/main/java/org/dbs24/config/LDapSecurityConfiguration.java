...
@Log4j2
@ConditionalOnProperty(name = "security.configuration.name", havingValue = "ldap")
public class LDapSecurityConfiguration extends AbstractSecurityConfig {

    @Bean
    public String bean1() {
        //log.info("LDapSecurityConfiguration");
        return "bean1_advanced";
    }
