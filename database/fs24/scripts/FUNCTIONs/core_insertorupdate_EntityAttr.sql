CREATE OR REPLACE FUNCTION core_insertorupdate_EntityAttr(p_entity_id tidcode, p_attr_id tidcode, p_bigdecimal_value tmoney, p_localdate_value tdate, p_integer_value tidcode, p_string2000_value tstr2000, p_string200_value tstr200, p_boolean_value tboolean, p_localdatetime_value tdatetime)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
