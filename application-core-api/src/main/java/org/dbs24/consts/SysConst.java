...
//    public static final int ES_CANCELLED = -1; // сделка аннулирована
    ...
    public static final Boolean CHECK_PARENT_CLASSES = Boolean.TRUE; // признак проверки родителского класса
    ...
    public static final String WEBSOCKET_PACKAGE = ALL_PACKAGES + ".websocket";
