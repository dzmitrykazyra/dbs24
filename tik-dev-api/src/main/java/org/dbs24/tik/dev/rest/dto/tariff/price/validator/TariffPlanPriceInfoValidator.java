 ...
 */
package org.dbs24.tik.dev.rest.dto.tariff.price.validator;
...
@Component
public class TariffPlanPriceInfoValidator extends AbstractValidatorService<TariffPlanPriceInfo> implements EntityInfoValidator<TariffPlanPriceInfo> {

    final RefsService refsService;

    public TariffPlanPriceInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(TariffPlanPriceInfo tikAccountScopeInfo) {
