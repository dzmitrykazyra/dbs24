 ...
 */
package org.dbs24.tik.dev.rest.dto.tariff.plan.validator;
...
@Component
public class TariffPlanInfoValidator extends AbstractValidatorService<TariffPlanInfo> implements EntityInfoValidator<TariffPlanInfo> {

    final RefsService refsService;

    public TariffPlanInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(TariffPlanInfo tikAccountScopeInfo) {
