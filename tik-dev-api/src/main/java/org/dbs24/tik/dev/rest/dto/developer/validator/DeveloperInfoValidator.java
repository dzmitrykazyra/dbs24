 ...
 */
package org.dbs24.tik.dev.rest.dto.developer.validator;
...
@Component
public class DeveloperInfoValidator extends AbstractValidatorService<DeveloperInfo> implements EntityInfoValidator<DeveloperInfo> {

    final RefsService refsService;

    public DeveloperInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(DeveloperInfo botInfo) {
