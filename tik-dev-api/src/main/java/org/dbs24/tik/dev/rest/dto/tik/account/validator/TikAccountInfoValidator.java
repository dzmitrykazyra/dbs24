 ...
 */
package org.dbs24.tik.dev.rest.dto.tik.account.validator;
...
@Component
public class TikAccountInfoValidator extends AbstractValidatorService<TikAccountInfo> implements EntityInfoValidator<TikAccountInfo> {

    final RefsService refsService;

    public TikAccountInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(TikAccountInfo botInfo) {
