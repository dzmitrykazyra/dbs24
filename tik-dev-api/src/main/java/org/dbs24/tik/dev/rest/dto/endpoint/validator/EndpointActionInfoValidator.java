 ...
 */
package org.dbs24.tik.dev.rest.dto.endpoint.validator;
...
@Component
public class EndpointActionInfoValidator extends AbstractValidatorService<EndpointActionInfo> implements EntityInfoValidator<EndpointActionInfo> {

    final RefsService refsService;

    public EndpointActionInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(EndpointActionInfo botInfo) {
