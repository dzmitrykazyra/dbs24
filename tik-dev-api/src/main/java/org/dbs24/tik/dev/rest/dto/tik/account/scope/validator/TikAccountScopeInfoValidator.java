 ...
 */
package org.dbs24.tik.dev.rest.dto.tik.account.scope.validator;
...
@Component
public class TikAccountScopeInfoValidator extends AbstractValidatorService<TikAccountScopeInfo> implements EntityInfoValidator<TikAccountScopeInfo> {

    final RefsService refsService;

    public TikAccountScopeInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(TikAccountScopeInfo tikAccountScopeInfo) {
