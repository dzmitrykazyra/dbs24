 ...
 */
package org.dbs24.tik.dev.rest.dto.contract.validator;
...
@Component
public class ContractInfoValidator extends AbstractValidatorService<ContractInfo> implements EntityInfoValidator<ContractInfo> {

    final RefsService refsService;

    public ContractInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(ContractInfo botInfo) {
