 ...
 */
package org.dbs24.tik.dev.rest.dto.tariff.limit.validator;
...
@Component
public class TariffLimitInfoValidator extends AbstractValidatorService<TariffLimitInfo> implements EntityInfoValidator<TariffLimitInfo> {

    final RefsService refsService;

    public TariffLimitInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(TariffLimitInfo tikAccountScopeInfo) {
