...
public class TariffLimitsTests extends AbstractTikDevApiTest {

    private Long createdTariffLimitId;

    @Order(100)
    @RepeatedTest(5)
    void createTariffLimit() {
        runTest(() -> createdTariffLimitId = createTestTariffLimit());
    }

    @Order(200)
    @Test
    void updateTariffLimit() { runTest(() -> createOrUpdateTestTariffLimit(createdTariffLimitId));
    }
}
