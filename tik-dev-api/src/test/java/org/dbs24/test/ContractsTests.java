...
public class ContractsTests extends AbstractTikDevApiTest {
    ...
    @RepeatedTest(5)
    void createContract() {
        runTest(() -> createdContractId = createTestContract());
    }

    @Order(200)
    @Test
    void updateContract() {
        runTest(() -> createOrUpdateTestContract(createdContractId));
    }
}
