...
public class TariffPlanPricesTests extends AbstractTikDevApiTest {

    private Long createdTariffPlanPriceId;

    @Order(100)
    @RepeatedTest(5)
    void createTariffPlanPrice() {
        runTest(() -> createdTariffPlanPriceId = createTestTariffPlanPrice());
    }

    @Order(200)
    @Test
    void updateTariffPlanPrice() { runTest(() -> createOrUpdateTestTariffPlanPrice(createdTariffPlanPriceId));
    }
}
