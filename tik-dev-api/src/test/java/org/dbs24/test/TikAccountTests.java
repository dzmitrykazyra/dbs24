...
public class TikAccountTests extends AbstractTikDevApiTest {

    private Long createdTikAccountId;

    @Order(100)
    @RepeatedTest(5)
    public void createTikAccount() {
        runTest(() -> createdTikAccountId = createTestTikAccount());
    }

    @Order(200)
    @Test
    public void updateTikAccount() {
        runTest(() -> createOrUpdateTestTikAccount(createdTikAccountId));
    }
}
