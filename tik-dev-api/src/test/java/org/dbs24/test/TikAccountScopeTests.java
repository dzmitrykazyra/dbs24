...
public class TikAccountScopeTests extends AbstractTikDevApiTest {

    private Long createdGranId;

    @Order(100)
    @RepeatedTest(5)
    public void createTikAccountScope() {
        runTest(() -> createdGranId = createTestTikAccountScope());
    }

    @Order(200)
    @Test
    public void updateTikAccountScope() {
        runTest(() -> createOrUpdateTestTikAccountScope(createdGranId));
    }
}
