...
public class DevelopersTests extends AbstractTikDevApiTest {
    ...
    public void createDeveloper() {
        runTest(() -> createdDeveloperId = createTestDeveloper());
    }

    @Order(200)
    @Test
    public void updateDeveloper() {
        runTest(() -> createOrUpdateTestDeveloper(createdDeveloperId));
    }
}
