...
public class BatchTemplatesTests extends AbstractAppPromoTest {

    private Integer createdBatchTemplateId;

    @Order(100)
    @RepeatedTest(5)
    public void createBatchTemplate() {
        runTest(() -> createdBatchTemplateId = createOrUpdateTestBatchTemplate(null));
    }

    @Order(200)
    @Test
    public void updateBatchTemplate() {
        runTest(() -> createOrUpdateTestBatchTemplate(createdBatchTemplateId));
    }
}
