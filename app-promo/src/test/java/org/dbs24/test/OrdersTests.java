...
public class OrdersTests extends AbstractAppPromoTest {
    ...
    public void createOrder() {
        runTest(() -> createdOrderId = createOrUpdateTestOrder(null));
    }

    @Order(200)
    @Test
    public void updateOrder() {
        runTest(() -> createOrUpdateTestOrder(createdOrderId));
    }
}
