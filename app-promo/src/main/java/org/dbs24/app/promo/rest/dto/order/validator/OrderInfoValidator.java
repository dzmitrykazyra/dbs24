 ...
 */
package org.dbs24.app.promo.rest.dto.order.validator;
...
@Component
public class OrderInfoValidator extends AbstractValidatorService<OrderInfo> implements EntityInfoValidator<OrderInfo> {

    final RefsService refsService;

    public OrderInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(OrderInfo orderInfo) {
