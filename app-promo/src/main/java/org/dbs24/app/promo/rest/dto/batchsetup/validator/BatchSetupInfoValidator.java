 ...
 */
package org.dbs24.app.promo.rest.dto.batchsetup.validator;
...
@Component
public class BatchSetupInfoValidator extends AbstractValidatorService<BatchSetupInfo> implements EntityInfoValidator<BatchSetupInfo> {

    final RefsService refsService;

    public BatchSetupInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(BatchSetupInfo batchSetupInfo) {
