 ...
 */
package org.dbs24.app.promo.rest.dto.action.validator;
...
@Component
public class OrderActionInfoValidator extends AbstractValidatorService<OrderActionInfo> implements EntityInfoValidator<OrderActionInfo> {

    final RefsService refsService;

    public OrderActionInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(OrderActionInfo orderActionInfo) {
