 ...
 */
package org.dbs24.app.promo.rest.dto.bot.validator;
...
@Component
public class BotInfoValidator extends AbstractValidatorService<BotInfo> implements EntityInfoValidator<BotInfo> {

    final RefsService refsService;

    public BotInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(BotInfo botInfo) {
