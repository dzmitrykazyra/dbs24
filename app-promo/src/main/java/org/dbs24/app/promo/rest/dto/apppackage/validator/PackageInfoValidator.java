 ...
 */
package org.dbs24.app.promo.rest.dto.apppackage.validator;
...
@Component
public class PackageInfoValidator extends AbstractValidatorService<PackageInfo> implements EntityInfoValidator<PackageInfo> {

    final RefsService refsService;

    public PackageInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(PackageInfo packageInfo) {
