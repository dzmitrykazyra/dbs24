 ...
 */
package org.dbs24.app.promo.rest.dto.batchtemplate.validator;
...
@Component
public class BatchTemplateInfoValidator extends AbstractValidatorService<BatchTemplateInfo> implements EntityInfoValidator<BatchTemplateInfo> {

    final RefsService refsService;

    public BatchTemplateInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(BatchTemplateInfo batchTemplateInfo) {
