 ...
 */
package org.dbs24.app.promo.rest.dto.comment.validator;
...
@Component
public class CommentInfoValidator extends AbstractValidatorService<CommentInfo> implements EntityInfoValidator<CommentInfo> {

    final RefsService refsService;

    public CommentInfoValidator(RefsService refsService) {
        this.refsService = refsService;
    }

    //==========================================================================
    @Override
    public Collection<ErrorInfo> validate(CommentInfo commentInfo) {
