...
//                .getRegParam("DefaultPaymentId", 1);
    ...
    //==========================================================================
    private void isValidDocuments( Integer template_id) {
    ...
    public void setSelectedPmtSysId( Integer selectedPmtSysId) {
    ...
    public void setDefaultDocTemplateId( Integer defaultDocTemplateId) {
